...
namespace xgui
{
	...
	{
		if (_parent)
			dynamic_cast<Model *>(_parent)->updateViews();
	...
	{
		if (_parent)
			dynamic_cast<Model *>(_parent)->insertInViews(element_parent, element_pos, element);
	...
	{
		if (_parent)
			dynamic_cast<Model *>(_parent)->removeInViews(element_parent, element_pos, element);
